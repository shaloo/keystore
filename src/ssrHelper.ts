...
export const kCombinations = (s: Array<number> | number, k: number): Array<Array<number>> => {
    let set = s
...
export type BigNumber = typeof BN;

export function lagrangeInterpolation(shares: Array<BigNumber> , nodeIndex: Array<BigNumber>): BigNumber {
